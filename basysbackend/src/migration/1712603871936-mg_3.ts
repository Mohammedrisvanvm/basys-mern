...
export class Mg31712603871936 implements MigrationInterface {
    name = 'Mg31712603871936'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "physicalStreet" character varying NOT NULL, "physicalCity" character varying NOT NULL, "physicalState" character varying NOT NULL, "physicalPostalCode" character varying NOT NULL, "physicalCountry" character varying NOT NULL, "billingStreet" character varying, "billingCity" character varying, "billingState" character varying, "billingPostalCode" character varying, "billingCountry" character varying, "userId" integer, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_d25f1ea79e282cc8a42bd616aa3" FOREIGN KEY ("userId") REFERENCES "entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
