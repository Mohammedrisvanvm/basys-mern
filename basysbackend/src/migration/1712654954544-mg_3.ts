...
export class Mg31712654954544 implements MigrationInterface {
    name = 'Mg31712654954544'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "firstName" character varying, "lastName" character varying NOT NULL, "nickName" character varying NOT NULL, "npi" character varying, "email" character varying NOT NULL, "accessRights" character varying NOT NULL, "active" boolean NOT NULL DEFAULT true, "status" character varying NOT NULL, "passwordIsTemporary" boolean NOT NULL DEFAULT true, "password" character varying NOT NULL, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
